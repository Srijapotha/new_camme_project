 ...
 *         description: Server error.
 */
router.post('/set-group-chat-pin', authMiddleware, setGroupChatPin);

/**
 * @swagger
 * /chat/verify-group-chat-pin:
 *   post:
 ...
 *         description: Server error.
 */
router.post('/verify-group-chat-pin', authMiddleware, verifyGroupChatPin);
